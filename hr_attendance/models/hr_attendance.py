...
class HrAttendance(models.Model):
    ...
    employee_id = fields.Many2one('hr.employee', string="e-Zestian", default=_default_employee, required=True, ondelete='cascade', index=True)
    ...
    #             raise exceptions.ValidationError(_("Cannot create new attendance record for %(empl_name)s, the e-Zestian was already checked in on %(datetime)s") % {
    #                 'empl_name': attendance.employee_id.name,
    ...
    #                 raise exceptions.ValidationError(_("Cannot create new attendance record for %(empl_name)s, the e-Zestian hasn't checked out since %(datetime)s") % {
    #                     'empl_name': attendance.employee_id.name,
